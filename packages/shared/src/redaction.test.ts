...
test('redacts known token formats, assignments, private keys, and high entropy strings', () => {
  const output = redactSecrets([
    ...
    'github=gh' + 'p_abcdefghijklmnopqrstuvwxyz1234567890',
    'google=AIz' + 'aSyabcdefghijklmnopqrstuvwxyz123456',
    '-----BEGIN PRIVATE KEY-----\nabc123\n-----END PRIVATE KEY-----',
  ...
  assert.doesNotMatch(output, /gh\p_abcdefghijklmnopqrstuvwxyz/);
  assert.doesNotMatch(output, /AI\zaSyabcdefghijklmnopqrstuvwxyz/);
