...
## 2024-08-11 - [Missing Foreign Key Indexes]
**Learning:** SQLite FOREIGN KEY definitions do not automatically create indexes, leading to O(N) full table scans during heavily queried nested or Promise.all lookups.
**Action:** Always explicitly pair FOREIGN KEY definitions and frequently queried columns (like job_id, receipt_id) with corresponding CREATE INDEX statements.
