...
You have two primary options for installing Helmr: package managers or oneliners.

### Option 1: Package Managers (npm or pnpm)

For the beta release, install the CLI globally using the `@beta` tag.
