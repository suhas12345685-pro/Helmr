...
**Option 1: Oneliners (Recommended)**
* **Windows (PowerShell):** `powershell -c "irm https://helmr.ai/install.ps1 | iex"`
* **macOS / Linux:** `curl -fsSL https://helmr.ai/install.sh | bash`

**Option 2: Package Managers**
* **npm:** `npm i -g helmr`
* **pnpm:** `pnpm add -g helmr`
